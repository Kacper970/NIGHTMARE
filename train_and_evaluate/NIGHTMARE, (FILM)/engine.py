...
def train_one_epoch(
    model, model_head, dataloader, device, epoch, optimizer, logger, args, combiner, channel, film
):
    ...
    if args.modality == 'text':
        ...
        for sequence1, sen1, sequence2, sen2, sequence3, sen3, candidates, y, sents in tqdm(dataloader):
            ...
            can_sens = film(can_sens, candidates)
...
def eval_one_epoch(
    model, model_head, dataloader, device, epoch, logger, best_acc, args, combiner, channel, film
):
