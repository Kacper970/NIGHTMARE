...
if __name__ == "__main__":
    ...
    parser.add_argument("--output-path", default="models/checkpoint_NIGHTMARE.pt")
    ...
    for epoch in range(args.epochs):
        train_one_epoch(
            model, model_head, train_dataloader, device, epoch, optimizer, wandb, args, 5, channel_proc, 5
        )
