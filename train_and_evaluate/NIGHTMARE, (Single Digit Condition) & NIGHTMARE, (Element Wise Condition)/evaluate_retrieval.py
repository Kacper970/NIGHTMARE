...
if __name__ == "__main__":
    ...
    parser.add_argument("--checkpoint-path", default="models/checkpoint_NIGHTMARE, (Single Digit Condition).pt")
    ...
    if not args.no_model:
        ...
        condition_weight.data.copy_(checkpoint["condition"])
    ...
    for num_candidates in args.num_candidates_steps:
        ...
        eval_one_epoch(
            ...
            experiment_tracker,
            best_acc,
            args, 5, channel_proc, condition_weight
        )
