...
if __name__ == "__main__":
    ...
    parser.add_argument("--output-path", default="models/checkpoint_NIGHTMARE, (Single Digit Condition).pt")
    ...
    optimizer = torch.optim.AdamW(
        ...
        + list(model_head["tok"].parameters()) + list(channel_proc.parameters()) + [condition_weight],
        lr=args.lr,
    )
    ...
    for epoch in range(args.epochs):
        train_one_epoch(
            model, model_head, train_dataloader, device, epoch, optimizer, wandb, args, combiner, channel_proc, condition_weight
        )
        ...
        new_best_acc = eval_one_epoch(
            ...
            wandb,
            best_acc,
            args, combiner, channel_proc, condition_weight
        )
        ...
        if new_best_acc["top5"] > best_acc["top5"]:
            ...
            state_dict = {
                ...
                "model_head_cls": model_head["cls"].state_dict(),  "channel": channel_proc.state_dict(), "condition": constraint.data.clone()
            }
