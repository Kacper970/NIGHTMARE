...
if __name__ == "__main__":
    ...
    parser.add_argument("--output-path", default="models/checkpoint_ComicBERT (Multimodal).pt")
    ...
    optimizer = torch.optim.AdamW(
        ...
        + list(model_head["tok"].parameters()) + list(bart.parameters()),
        lr=args.lr,
    )
    ...
    for epoch in range(args.epochs):
        train_one_epoch(
            model, model_head, train_dataloader, device, epoch, optimizer, wandb, args, combiner, channel_proc, bart
        )
        ...
        new_best_acc = eval_one_epoch(
            ...
            wandb,
            best_acc,
            args, combiner, channel_proc, bart
        )
        ...
        if new_best_acc["top5"] > best_acc["top5"]:
            ...
            state_dict = {
                ...
                "model_head_cls": model_head["cls"].state_dict(),  "bart" : bart.state_dict()
            }
