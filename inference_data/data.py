...
def generate_candidate_sampling_key(
    ...
    with open(f"{data_dir}/{split}_{source}_{modality}_{sampling_level}_sampling.json", "w+") as f:
    ...
    def random_partial_sample(self, idx):
        ...
        while len(candidates) < self.num_candidates:
            ...
            sen = self.panels_file[
                f"{self.split}_{self.source}_{self.modality}/{comic}/str_data2"
            ][panel_idx]
...
# =============================================================================
    ...
    def _fetch_panel(self, idx):
        ...
        if self.modality == 'text':
            ...
            sen = self.panels_file[f"{self.split}_{self.source}/{comic}/str_data2"][panel_idx]
